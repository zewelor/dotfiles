...
Most tools in this repo use Catppuccin **Latte** as the base flavor. Some tools (lazygit, lazydocker, atuin) also allow picking an **accent color** within that flavor:
...
- **Tools that support accents**:
  ...
  - `lazydocker` — `.config/jesseduffield/lazydocker/config.yml`
